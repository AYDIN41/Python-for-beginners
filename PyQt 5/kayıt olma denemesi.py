...
class Pencere(QtWidgets.QWidget):
    ...
    def init_ui(self):
        ...
        self.regis = QtWidgets.QPushButton("Kayıt Olunuz")
        ...
        self.regis.clicked.connect(self.register)
    ...
    def register(self):
        ...
        if(len(sorgu) == 0):
            self.yazi_alani.setText("Giriş işlemininiz kabul edilmedi")
        else:
            self.yazi_alani.setText("Başarı ile kayıt yaptınız " + isim)
