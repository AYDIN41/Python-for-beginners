...
class doviz():
    ...
    doviz = input(
        "Turk lirası karşısında degerini görmek istediginiz birimi giriniz: ")
    soup = BeautifulSoup(
        html_icerik,
        "html.parser")
    turkLirasi = 1
...
class Pencere(QtWidgets.QWidget):
    ...
    def init_ui(self):
        ...
        self.ac.clicked.connect(self.dosyaAC)
    def dosyaAC(self):
        dosyaislemi = QtWidgets.QFileDialog.getOpenFileName(self,"Dosya Arama",os.getenv("HOME"))
        with open()
